package com.zaotao.indicator.buildins.commonnavigator.titles.badge;
    ...
    public void setXBadgeRule(BadgeRule badgeRule) {
        if (badgeRule != null) {
            ...
            if (anchor != BadgeAnchor.LEFT
                ...
                throw new IllegalArgumentException("x badge rule is releasedynamic_finish_icon.");
            }
        }
    ...
    public void setYBadgeRule(BadgeRule badgeRule) {
        if (badgeRule != null) {
            ...
            if (anchor != BadgeAnchor.TOP
                ...
                throw new IllegalArgumentException("y badge rule is releasedynamic_finish_icon.");
            }
        }
