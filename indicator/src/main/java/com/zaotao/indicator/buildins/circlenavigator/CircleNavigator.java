package com.zaotao.indicator.buildins.circlenavigator;
...
public class CircleNavigator extends View implements IPagerNavigator {
    ...
    private void drawIndicator(Canvas canvas) {
        mPaint.setStyle(Paint.Style.FILL);
        mPaint.setColor(mIndicatorCircleColor);
    ...
    public void setIndicatorCircleColor(int circleColor) {
        mIndicatorCircleColor = circleColor;
        invalidate();
    }
